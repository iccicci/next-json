...
const tests: Record<string, [string, string]> = {
  ...
  "not closed array 1":           ["[", 'Expected "Object", "[", "]", "false", "new", "null", "true", "undefined", "{", [A-Z], number, or string but end of input found at 1:2'],
  "not closed array 2":           ["[0", 'Expected "," or "]" but end of input found at 1:3'],
  "not closed array 3":           ["[0,", 'Expected "Object", "[", "]", "false", "new", "null", "true", "undefined", "{", [A-Z], number, or string but end of input found at 1:4'],
  ...
  "not closed object 3":          ['{"a":', 'Expected "Object", "[", "false", "new", "null", "true", "undefined", "{", [A-Z], number, or string but end of input found at 1:6'],
  ...
  "not closed string":            ['{"":"', 'Expected "Object", "[", "false", "new", "null", "true", "undefined", "{", [A-Z], number, or string but "\\"" found at 1:5'],
