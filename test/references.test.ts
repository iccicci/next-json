...
const circular_objects = {
  ...
  replacer:  {
    ...
    contextes: '((A,B)=>{return [{"":Object.assign(A,{"object2":Object.assign(B,{"object1":A})})},A,A,B,B]})({"njson":"test"},{"test":"njson"})',
    func:      noop
  },
  reviver: {
    ...
    contextes: '((A,B)=>{return [Object.assign(A,{"object2":Object.assign(B,{"object1":A})}),B,B,A,{"":A}]})({"njson":"test"},{"test":"njson"})',
    func:      noop
  },
...
const circular_arrays = {
  ...
  replacer:  {
    ...
    contextes: '((A,B,C)=>{A.push(B,42);B.push(A,3);return [{"":Object.assign(C,{"array1":A,"array2":B})},C,A,A,B,B,B,B,A,C]})([23],[1,2],{})',
    func:      noop
  },
  reviver: {
    calls:     '((A,B)=>{A.push(B,42);B.push(A,3);return [["0",23],["0",1],["1",2],["2",A],["3",3],["1",B],["2",42],["array1",A],["array2",B],["",{"array1":A,"array2":B}]]})([23],[1,2])',
    contextes: '((A,B,C)=>{A.push(B,42);B.push(A,3);return [A,B,B,B,B,A,A,Object.assign(C,{"array1":A,"array2":B}),C,{"":C}]})([23],[1,2],{})',
    func:      noop
  },
...
const circular_sets = {
  ...
  replacer:  {
    ...
    contextes: '((A,B,C)=>{return [{"":A.add(B.add(A).add(C)).add(new Int8Array([23,42]))},A,A,B,B,B,B,C,A]})(new Set(["njson"]),new Set([23,42]),{"test":"njson"})',
    func:      noop
  },
  reviver: {
    calls:
    ...
    contextes: '((A,B,C)=>{return [A.add(B.add(A).add(C)).add(new Int8Array([23,42])),B,B,B,C,B,A,A,{"":A}]})(new Set(["njson"]),new Set([23,42]),{"test":"njson"})',
    func:      noop
  },
...
const long_strings = {
  ...
  replacer:  {
    ...
    contextes: '((A,B,C)=>{B.push(C,A);C.push(A,B);return [{"":B},B,C,C,B]})("long string",[],[])',
    func:      noop
  },
  reviver: {
    calls:     '((A,B,C)=>{B.push(C,A);C.push(A,B);return [["0",A],["1",B],["0",C],["1",A],["",B]]})("long string",[],[])',
    contextes: '((A,B,C)=>{B.push(A,C);C.push(B,A);return [B,B,C,C,{"":C}]})("long string",[],[])',
    func:      noop
  },
...
const repeated_references = {
  ...
  replacer:  {
    ...
    contextes: '((A,B,C,D)=>{D.push(A,B,C,A,B,C);return [{"":D},D,D,D,D,D,C,D,D,D]})(new Uint8Array([110,106,115,111,110]),new Map(),new Set(["njson"]),[new Set(),new Map()])',
    func:      noop
  },
  reviver: {
    calls:
    ...
    contextes: '((A,B,C,D)=>{D.push(A,B,C,A,B,C);return [D,D,D,D,C,D,D,D,D,{"":D}]})(new Uint8Array([110,106,115,111,110]),new Map(),new Set(["njson"]),[new Set(),new Map()])',
    func:      noop
  },
...
const repeated_references_created = {
  ...
  replacer:  {
    ...
    contextes: '((A,B,C,D,E)=>{A.push(B,1,2,C,D,5,6,E);return [{"":A},A,A,B,A,C,A,A,D,D,A,A,E,E,E,A]})([],{"test":"njson"},{"njson":"test"},[23,42],[1,2,3])',
    func:      replacer1
  },
  reviver: {
    calls:
    ...
    contextes: '((A,B,C,D,E)=>{E.push(A,A,B,B,C,C,D,D);return [E,A,E,B,E,E,C,C,E,E,D,D,D,E,E,{"":E}]})({"test":"njson"},{"njson":"test"},[23,42],[1,2,3],[])',
    func:      reviver1
  },
...
const repeated_references_removed = {
  ...
  replacer:  {
    ...
    contextes: '((A,B,C,D,E)=>{E.push(A,A,B,B,C,C,D,D);return [{"":E},E,E,A,E,B,E,E,C,C,E,E,D,D,D,E]})({"test":"njson"},{"njson":"test"},[23,42],[1,2,3],[])',
    func:      replacer2
  },
  reviver: {
    calls:
    ...
    contextes: '((A,B,C,D,E)=>{B.push(A,C,3,4,D,E,7);return [B,A,B,C,B,B,D,D,B,B,E,E,E,B,B,{"":B}]})({"test":"njson"},[0],{"njson":"test"},[23,42],[1,2,3])',
    func:      reviver2
  },
